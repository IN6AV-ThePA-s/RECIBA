                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="mb-3">
                                <label htmlFor="surname" className="form-label">Initial Exp</label>
                                <input onChange={handleForm} defaultValue={initExp} type="email" className="form-control" id="initExp" name='initExp' />

                            </div>

                            <div className="mb-3">
                                <label htmlFor="username" className="form-label">Limit Exp</label>
                                <input onChange={handleForm} defaultValue={limitExp} type="email" className="form-control" id="limitExp" name='limitExp' />
